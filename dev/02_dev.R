...
golem::add_module(name = "plot_data", with_test = TRUE) # Name of the module
golem::add_module(name = "mod_seriesid", with_test = TRUE) # Name of the module
golem::add_module(name = "module_3", with_test = TRUE) # Name of the module
